...
from mlopskit.assets.errors import ObjectDoesNotExistError
from mlopskit.assets.manager import AssetsManager
from mlopskit.assets.remote import StorageProvider
...
@click.option("--storage-prefix", envvar="MLOPSKIT_STORAGE_PREFIX")
...
def update(asset_path, asset_spec, storage_prefix, bump_major, dry_run):
    ...
    set in MLOPSKIT_ASSETS_VERSIONING_SYSTEM (major/minor by default)
    ...
    versioning_system = os.environ.get(
        "MLOPSKIT_ASSETS_VERSIONING_SYSTEM", "major_minor"
    )
