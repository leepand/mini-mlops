...
from mlopskit.utils.loadobj import load_obj
...
_DEFAULT_PACKAGES = ["mlopskit.io.", "mlopskit.ext.store.", ""]
...
def _load_obj(class_path: str) -> Optional[object]:
    ...
    #                 `__all__` attribute -- either because it's a custom or a mlopskit.io dataset
    ...
    try:
        ...
        if available_classes and class_name in available_classes:
            raise DataSetError(
                ...
                f"https://mlopskit.readthedocs.io/en/stable/"
                f"mlopskit_project_setup/dependencies.html"
            ) from exc
        return None
    ...
    def __init__(
        ...
        Args:
            ...
            version: If specified, should be an instance of
                ``mlopskit.io.core.Version``. If its ``load`` attribute is
...
# p = PurePath('10.0.0.1:9001',"setup.py")
# get_filepath_str(p,'gcs')
